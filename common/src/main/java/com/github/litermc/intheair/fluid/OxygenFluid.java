...
public abstract class OxygenFluid extends WaterFluid implements IEvaporableFluid {
	@Override
	public Fluid getFlowing() {
		return ITAFluids.OXYGEN_FLOWING;
	}

	@Override
	public Fluid getSource() {
		return ITAFluids.OXYGEN;
	}

	@Override
	public Item getBucket() {
		return ITAItems.OXYGEN_BUCKET;
	}
